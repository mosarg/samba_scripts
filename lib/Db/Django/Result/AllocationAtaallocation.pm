use utf8;
package Db::Django::Result::AllocationAtaallocation;
...
=head1 TABLE: C<allocation_ataallocation>

=cut

__PACKAGE__->table("allocation_ataallocation");
...
=head2 ataAllocationId_id

  accessor: 'ata_allocation_id_id'
  data_type: 'integer'
  is_foreign_key: 1
  is_nullable: 0
...
=item * L</ataAllocationId_id>

=back

=cut

__PACKAGE__->set_primary_key("ataAllocationId_id");

=head1 RELATIONS

=head2 ata_allocation_id
...
__PACKAGE__->belongs_to(
  ...
  { allocationId => "ataAllocationId_id" },
