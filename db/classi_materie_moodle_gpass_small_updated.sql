...
INSERT INTO `allocation_schoolyear` VALUES ('2013-08-21 14:28:11','2013-08-21 14:28:11',3,2012,'Auto insert',1);
...
CREATE TABLE `sysuser_sysuser` (
  ...
  `syncModel` varchar(30) DEFAULT NULL,
  PRIMARY KEY (`userId`),
...
-- Dump completed on 2013-08-21 16:31:51
